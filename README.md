...
Le fichier [`decision-dashboard-summary.pdf`](assets/pdf/decision-dashboard-summary.pdf) est un **rapport de synthèse automatiquement généré** par le script `scripts/generate_pdf_summary.py`. Il contient 5 pages :
...
- [`scripts/generate_pdf_summary.py`](scripts/generate_pdf_summary.py) — Génération du PDF de synthèse décisionnelle
